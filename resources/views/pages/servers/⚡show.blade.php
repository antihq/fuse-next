...
new #[Title('Server Details')] class extends Component
{
    ...
    {
        return "ssh root@{$this->server->ip_address} 'bash <(curl -s https://example.com/provision.sh)'";
    }
...
<section class="w-full">
    ...
    <div class="mt-8 space-y-6">
        ...
        <div class="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:subheading class="mb-4">{{ __('Run this command on your local machine to provision server') }}</flux:subheading>
        ...
        <div class="mt-8 space-y-6">
            ...
            <div class="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-900">
                <flux:heading size="lg" class="mb-4">{{ __('Provisioning Command') }}</flux:heading>
                <flux:subheading class="mb-4">{{ __('Run this command on your local machine to provision the server') }}</flux:subheading>
